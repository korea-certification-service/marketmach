...
document.addEventListener("DOMContentLoaded", function () { 
    ...
    var srchBoxWrapWidth;
    var srchBoxWrapHeight;
    ...
    function setSize(num){
        ...
        if(num == 0){
            ...
            srchBoxLeft.style.width = ( srchBoxWrapWidth / 3 ) + "px";

            srchBoxRight.style.width = ( srchBoxWrapWidth * 2 / 3 ) + "px";
            srchBoxRight.style.height = srchBoxWrapHeight + "px";

        } else {

            srchBoxLeft.style.width = 100 + "%";

            srchBoxRight.style.width = 0 + "px";
            srchBoxRight.style.height = 0 + "px";
