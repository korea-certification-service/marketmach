...
let upload = multer({ dest: '/data/resources/img/kyc' });
router.post('/:kycId/images', upload.array('image'), function (req, res, next) {
    ...
    if (kycId != null) {
        ...
        for(var i =0; i< req.files.length; i++) {
            let image = {
                "path": dbconfig.resources_path + "kyc/" + req.files[i].location,
